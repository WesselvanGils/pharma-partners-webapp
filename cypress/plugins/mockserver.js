...
const mockMeeting = [
  {
    ...
    meeting: {
      title: "Test Meeting",
      start: {
        $date: "2021-12-20T09:30:00.000Z"
      },
      end: {
        $date: "2021-12-20T10:30:00.000Z"
      }
    }
  }
];
...
routes.get("/api/authentication/validate/:id", (req, res, next) =>
{
  res.status(200).json(validEmployeeData);
});
...
routes.get("/api/meetings/doctor/:id", (req, res, next) =>
{
  res.status(200).json(mockMeeting);
});
//
